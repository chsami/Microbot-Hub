...
import static net.runelite.client.plugins.microbot.sandminer.GabulhasSandMinerInfo.botStatus;
import static net.runelite.client.plugins.microbot.sandminer.GabulhasSandMinerInfo.states;
