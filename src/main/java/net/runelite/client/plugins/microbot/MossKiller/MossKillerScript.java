...
public class MossKillerScript extends Script {
    ...
    public static int LAMP = 2528;

    // TODO: add stuff for boss too
    public int[] LOOT_LIST = new int[]{MOSSY_KEY, LAW_RUNE, AIR_RUNE, FIRE_RUNE, COSMIC_RUNE, DEATH_RUNE, CHAOS_RUNE, NATURE_RUNE, MAGIC_STAFF, EARTH_RUNE, SPINACH_ROLL,STEEL_BAR,LAMP};
