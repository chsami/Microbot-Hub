...
/** Trains Defence to the target level. */
@Slf4j
public class TrainDefenceTask extends AbstractTask {
    ...
    public String getName() {
        return "Train Defence to " + targetLevel;
    }

    @Override
    public boolean isComplete() {
        return Microbot.getClient().getRealSkillLevel(Skill.DEFENCE) >= targetLevel;
    }
